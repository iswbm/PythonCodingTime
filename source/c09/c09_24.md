...
goroutine 1 [running]:
main.main()
        E:/MING-Code/GoPlayer/src/imooc.com/ccmouse/learngo/main.go:4 +0x40
exit status 2
```
...
goroutine 6 [running]:
main.main.func1()
        E:/MING-Code/main.go:12 +0x7b
created by main.main
        E:/MING-Code/main.go:10 +0xbc
exit status 2
```
...
revocer 调用后，抛出的 panic 将会在此外终结，不会再外抛，但是 recover，并不能任意使用，它有强制要求，必须得在 defer 下才能发挥用途。

![image-20200301121138527](upload\image-20200301121138527.png)