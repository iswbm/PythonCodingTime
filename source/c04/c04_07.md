...
![](http://image.iswbm.com/image-20200321163152876.png)
...
- 在Github上创建名字为XXX.github.io的项目，XXX为自己的github用户名。然后 clone 到你的本地电脑上。
  ...
  ![](http://image.iswbm.com/image-20200321165634287.png)
...
![](http://image.iswbm.com/image-20200321171008622.png)
...
- 去阿里云 域名云解析
  ![](http://image.iswbm.com/image-20200321171939919.png)
  
- 然后到对应的GitHub仓库，绑定我的个性域名
  ![](http://image.iswbm.com/image-20200321171821683.png)
...
```
效果如下
![](http://image.iswbm.com/17-9-10/85269241.jpg)
...
![image-20200321201555321](http://image.iswbm.com/image-20200321201555321.png)
...
![](http://image.iswbm.com/17-9-9/63041495.jpg)
代码如下：
...
![](http://image.iswbm.com/image-20200321193444320.png)
