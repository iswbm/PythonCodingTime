...
![](http://image.iswbm.com/FhkX5Ko3LVZL_p7YfitDsTDxvHmL)
...
![](http://image.iswbm.com/20190507215525.png)
...
![](http://image.iswbm.com/20190419152120.png)
...
![](http://image.iswbm.com/20190507220740.png)
...
![](http://image.iswbm.com/20190506150010.png)

添加如下这一行（请根据你的实际安装目录自行调整）

![](http://image.iswbm.com/20190506150100.png)

若是 Mac OS 系统，请找到并进入你的 Pycharm 安装启动目录（以我的为例）

将第一步下载的 jar 包放入这个目录

![](http://image.iswbm.com/20190507000850.png)

并打开如下一个以 `vmoptions` 后缀结尾的文件：

![](http://image.iswbm.com/20190507001025.png)
...
![](http://image.iswbm.com/20190507001422.png)

如果是 Mac  OS 系统，重启 PyCharm 后，查看激活信息：PyCharm -> About PyCharm

![](http://image.iswbm.com/20190507001350.png)
...
![](http://image.iswbm.com/20190616221620.png)

- 精准定位到类：Windows（Ctrl+N），Mac（Command+N）

![](http://image.iswbm.com/20190616232746.png)

- 精准定位到符号：类的所有成员（函数、变量等）都可以称之为符号，Windows（Ctrl+Alt+Shift+N），Mac（Option+Shift+Command+N）

![](http://image.iswbm.com/20190616233827.png)
...
![](http://image.iswbm.com/20190616235007.png)
...
![](http://image.iswbm.com/20190629183430.png)
...
![](http://image.iswbm.com/20190629231322.png)
...
![](http://image.iswbm.com/20191211210012.png)
