...
发现和预期一样，真的报错了。说明我们指定的虚拟环境有效果。 |image3|

4.3 PyCharm中
~~~~~~~~~~~~~

点击 File - Settings - Project - Interpreter |image4|
点击小齿轮。如图点击添加，按提示添加一个虚拟环境。然后点 OK
就可以使用这个虚拟环境，之后的项目都会在这个虚拟环境下运行。 |image5|
...
.. |image1| image:: http://image.python-online.cn/20200209161935.png
.. |image2| image:: https://i.loli.net/2018/06/11/5b1e7d36ce8ad.png
.. |image3| image:: https://i.loli.net/2018/06/11/5b1e7f140be6a.png
.. |image4| image:: https://i.loli.net/2018/06/11/5b1e805c996c8.png
.. |image5| image:: https://i.loli.net/2018/06/11/5b1e812db603f.png
