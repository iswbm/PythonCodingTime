...
![](https://i.loli.net/2018/04/15/5ad2c14727198.png)
...
在 7.2 章节，我在机器上生成了一对私钥和公钥。

现在搜索启动PuTTY Key Generator

![](http://image.python-online.cn/20190418211644.png)

点击 `Load` ，选择你之前创建的私钥。然后点`Save private key` 存到你指定的目录下。

![](http://image.python-online.cn/20190418211729.png)

然后 点击托盘隐藏图标 Pageant，点击 `Add key` 选择刚刚保存的那个文件即可。
