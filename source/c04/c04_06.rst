...
|image1| 生成的私钥 ``/c/Users/wangbm/.ssh/id_rsa``\ ，由本机电脑保存。
生成的仅钥 ``/c/Users/wangbm/.ssh/id_rsa.pub``\ ，需要在Github上添加。

在github上添加ssh keys方法如下： |image2|
...
.. |image1| image:: https://i.loli.net/2018/04/15/5ad2c06e8893d.png
.. |image2| image:: http://image.python-online.cn/20190511163855.png
.. |image3| image:: https://i.loli.net/2018/04/15/5ad2c2a9813b9.png
.. |image4| image:: http://image.python-online.cn/20190430235625.png
