...
前几天我在看 OpenStack
框架的时候，不小心改动了几行代码，导致了语法错误，这也是事后过了许久才在导航栏这里出现的波浪线发现了。

|image51|

由于是手误，我也不知道我改动了哪一行，这个文件有将近8000行的代码，难道一行一行地去找？不太现实。

PyCharm 提供给我们一个 Keymap 的面板，可以很方便的设置、查询快捷键。
...
https://blog.csdn.net/xiemanR/article/details/73379163
