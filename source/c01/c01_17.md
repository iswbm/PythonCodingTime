...
- [Python描述器引导(翻译)](https://pyzh.readthedocs.io/en/latest/Descriptor-HOW-TO-Guide.html#id8)[¶](https://pyzh.readthedocs.io/en/latest/Descriptor-HOW-TO-Guide.html#python)
